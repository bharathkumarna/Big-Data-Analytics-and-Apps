...
object IPApp {
  ...
  val IMAGE_CATEGORIES = List("acid_rain", "global_temp_rise", "ice_sheet_melting", "ocean_acidification", "warming_oceans")
  ...
  def main(args: Array[String]) {
    ...
    /**
      ...
      *
      * This shall be used as a input to DecisionTree Classifier to create a model
      */
    createHistogram(sc, images)

    /**
      * From the labeled Histograms a DecisionTree Model is created
      */
