...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/example.mkv"));
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/1.png"));
            modelImage2 = ImageUtilities.readMBF(new File("data/2.png"));
            modelImage3 = ImageUtilities.readMBF(new File("data/3.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
